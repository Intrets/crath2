...
#define CR_MACRO_DATA_TYPE int4x4
...
namespace cr::simd
{
	...
	struct int4x4
	{
		...
		CR_INLINE int4x4() = default;
		CR_INLINE int4x4(__m128i i1_, __m128i i2_, __m128i i3_, __m128i i4_)
		    : i1(i1_),
		      i2(i2_),
		      i3(i3_),
		      i4(i4_) {
		}
		CR_INLINE int4x4(int32_t i)
		    : i1(_mm_set1_epi32(i)),
		      i2(_mm_set1_epi32(i)),
		      i3(_mm_set1_epi32(i)),
		      i4(_mm_set1_epi32(i)) {
		}
		CR_INLINE int4x4(int32_t const* ptr, aligned_hint_t)
		    : i1(_mm_load_si128(reinterpret_cast<__m128i const*>(ptr))),
		      ...
		      i4(_mm_load_si128(reinterpret_cast<__m128i const*>(ptr + 12))) {
		}
		CR_INLINE int4x4(int32_t const* ptr)
		    : i1(_mm_loadu_si128(reinterpret_cast<__m128i const*>(ptr))),
		      ...
		      i4(_mm_loadu_si128(reinterpret_cast<__m128i const*>(ptr + 12))) {
		}
		...
		CR_INLINE void write(int32_t& s) const {
			...
			_mm_storeu_si128(reinterpret_cast<__m128i*>(&s + 12), this->i4);
		}
		...
		CR_INLINE void write(int32_t& s, aligned_hint_t) const {
			...
			_mm_store_si128(reinterpret_cast<__m128i*>(&s + 12), this->i4);
		}

		CR_INLINE int4x4 operator>>(int shift) const {
			return {
				_mm_srli_epi32(this->i1, shift),
				_mm_srli_epi32(this->i2, shift),
				_mm_srli_epi32(this->i3, shift),
				_mm_srli_epi32(this->i4, shift)
			};
		}

		CR_ALL_INT_DEFINITIONS

		float4x4 bitCastFloat() const;
	};
}
...
namespace cr::simd
{
	...
	struct int4x4
	{
		...
		CR_INLINE int4x4(in_t(int32x4_t) i1_, in_t(int32x4_t) i2_, in_t(int32x4_t) i3_, in_t(int32x4_t) i4_)
		    : i1(i1_),
		      i2(i2_),
		      i3(i3_),
		      i4(i4_) {
	...
	public:
		CR_INLINE int4x4(int32_t i0, int32_t i1, int32_t i2, int32_t i3, int32_t i4, int32_t i5, int32_t i6, int32_t i7, int32_t i8, int32_t i9, int32_t i10, int32_t i11, int32_t i12, int32_t i13, int32_t i14, int32_t i15)
		    : i1(helperLoad(i0, i1, i2, i3)),
		      i2(helperLoad(i4, i5, i6, i7)),
		      i3(helperLoad(i8, i9, i10, i11)),
		      i4(helperLoad(i12, i13, i14, i15)) {
		}
		...
		CR_INLINE int4x4 operator+(in_t(int4x4) a) const {
			return {
				vaddq_s32(this->i1, a.i1),
				vaddq_s32(this->i2, a.i2),
				vaddq_s32(this->i3, a.i3),
				vaddq_s32(this->i4, a.i4)
			};
		}
		...
		CR_INLINE int4x4 operator<<(in_t(int4x4) a) const {
			return {
				...
				vshlq_s32(this->i4, a.i4)
			};
		}

		CR_INLINE int4x4 operator>>(int a) const {
			return (*this) << int4x4(-a);
		}

		float4x4 bitCastFloat() const;
		float4x4 castFloat() const;
	};
}
